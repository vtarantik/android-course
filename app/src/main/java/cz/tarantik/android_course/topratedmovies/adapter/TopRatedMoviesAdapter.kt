package cz.tarantik.android_course.topratedmovies.adapter
...
class TopRatedMoviesAdapter(private val onMovieClicked: (movieId: Int) -> Unit) :
    ListAdapter<Movie, TopRatedMoviesAdapter.MovieViewHolder>(MovieDiffCallback) {
